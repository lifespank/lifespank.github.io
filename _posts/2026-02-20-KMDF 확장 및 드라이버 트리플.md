...
**참고:** 이 항목을 읽기 전에 [**미니 드라이버, 미니포트 드라이버 및 드라이버 쌍**]({% post_url 2026-02-12-미니 드라이버 미니포트 드라이버 및 드라이버 쌍 %}) 및 [**일반 드라이버 쌍 모델로서의 KMDF**]({% post_url 2026-02-13-일반 드라이버 쌍 모델로서의 KMDF %})에서 제시된 개념을 이해해야 한다.
{: .notice--info}
