...
### 프로필
![picture 6]({{ "/assets/img/k8NzM9j.png" | relative_url }})

본인 프로필을 확인하고 수정할 수 있다.
### 찾기
![picture 7]({{ "/assets/img/k5CPAVq.png" | relative_url }})

틴더처럼 다른 사용자의 간단한 프로필이 나오며, 좌우로 스와이프하요 '싫어요' '좋아요'를 선택 가능하다.
### 매치
![picture 8]({{ "/assets/img/wMUDrgk.png" | relative_url }})

서로 좋아요를 눌렀다면 이 탭에 뜨게 된다.
## 앱 구조

| ![picture 9]({{ "/assets/img/NIzSeeh.png" | relative_url }}) |
|:--:|
| *구글 권장 아키텍처* |
...
| ![picture 10]({{ "/assets/img/IbU3ZQv.png" | relative_url }}) |
|:--:|
...
| ![picture 11]({{ "/assets/img/meP6pPj.png" | relative_url }}) |
|:--:|
...
![picture 12]({{ "/assets/img/yrgwKRE.png" | relative_url }})  
