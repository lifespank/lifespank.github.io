...
| ![picture 9]({{ "/assets/img/SH2pxGf.png" | relative_url }}) |
|:--:|
| *코틀린 코드* |

| ![picture 10]({{ "/assets/img/9ic9Y9Y.png" | relative_url }}) |
|:--:|
| *바이트코드* |

| ![picture 11]({{ "/assets/img/liaOtcm.png" | relative_url }}) |
|:--:|
| *디컴파일된 자바 코드* |
...
| ![picture 12]({{ "/assets/img/Yf2tr98.png" | relative_url }}) |
|:--:|
| *코틀린 코드에서 Glide 라이브러리를 사용* |

| ![picture 13]({{ "/assets/img/pK1XJQg.png" | relative_url }}) |
|:--:|
| *Glide 자바 코드의 일부* |
