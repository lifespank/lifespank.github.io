...
![picture 2]({{ "/assets/img/8fmzuOP.png" | relative_url }})  

![picture 3]({{ "/assets/img/jk1LCok.png" | relative_url }})  

먼저 회원가입을 하고 프로젝트를 선택한다. COVID-19, 결핵, 암 등등 여러 프로젝트가 있다.

![picture 4]({{ "/assets/img/Nxv9PzX.png" | relative_url }})  
...
![picture 5]({{ "/assets/img/Q24mckm.png" | relative_url }})  

Add Project에서 World Community Grid를 선택하고 아까 가입했던 이메일과 비밀번호를 입력하면 태스크가 할당된다.

![picture 6]({{ "/assets/img/ryB12Yc.png" | relative_url }})
